...
output "victorops_notify" {
  description = "The VictorOps notify string generated by this module, regardless of whether VictorOps is enabled in the config or not."
  value       = local.victorops_notify
}
